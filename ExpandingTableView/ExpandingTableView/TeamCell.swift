...
extension ConferenceCell.DivisionCell {
  class TeamCell: UITableViewCell {
    struct Constants {
      ...
      static let borderColor: UIColor = UIColor(red: 1, green: 0.161, blue: 0.161, alpha: 1)
      static let backColor: UIColor = UIColor(red: 20 / 255, green: 20 / 255, blue: 20 / 255, alpha: 1)
    }
    static let id: String = "TeamCellID"
    
    let label: UILabel = UILabel()
    let logo: UIImageView = UIImageView()
    let roundedRectBackground: UIView = UIView()

    
    var team: NFL.Team = NFL.Team(name: "Kansas City Chiefs", abbrev: "KC") {
      didSet {
